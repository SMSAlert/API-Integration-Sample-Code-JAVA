...
public class SendSms {
    ...
    public static  void setapi_url(String ap){
     ...
     public  void setparams(String ap,String apk,String sd){
		...
		*/
	  public String process_sms(String mob_no,String message,String unicode,String time) throws IOException,MalformedURLException, KeyManagementException, NoSuchAlgorithmException
		{   	
	        ...
	        URL url = new URL(""+start+api_url+"/api/push.json?apikey="+api_key+"&sender="+sender_id+"&mobileno="+mob_no+"&text="+message+unicode+time );
     ...
     public  void send_sms(String mob_no,String message) throws IOException,MalformedURLException, KeyManagementException, NoSuchAlgorithmException
		{
